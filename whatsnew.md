...
- Custom context menu options displayed on ignored elements
- Contextmenu is not closed on click outside
...
Provides all the same functionality as Svelte Filemanager 2.2.0
